...
class CustomUserAdmin(DefaultUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'password1', 'password2', 'is_authorised', 'is_student', 'is_teacher', 'is_admin')}
         ),
    )
    ...
    list_filter = ('is_student', 'is_teacher', 'is_admin', 'is_authorised', 'is_staff', 'is_superuser')
